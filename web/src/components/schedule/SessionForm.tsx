...
export function SessionForm({ campId, dayId, streams, onClose, onSuccess }: SessionFormProps) {
        ...
        <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-white dark:bg-slate-900 rounded-2xl w-full max-w-2xl shadow-2xl overflow-hidden border border-slate-200 dark:border-slate-800">
                ...
                <div className="p-6 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between">
                    <h2 className="text-xl font-bold text-slate-900 dark:text-white">Add New Session</h2>
                    <button
                        onClick={onClose}
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="e.g., On-Ice Skills Training"
                            required
                        />
                    </div>
                    ...
                    <div>
                        ...
                        {streams.length === 0 ? (
                            <p className="text-sm text-slate-500 italic">No streams available. Create streams first.</p>
                        ) : (
